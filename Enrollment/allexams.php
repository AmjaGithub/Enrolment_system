...
<body class="p-10 text-gray-800">
    ...
    <section class="bg-purple-100 rounded-2xl p-5">
        <div class="container mx-auto">   
            <div class="flex">
                ...
                <li class="pr-5"><a href="Exam.php" class="px-3 py-2 border border-purple-100 hover:border-purple-300 rounded ">Repet Exam Application</a></li>
    ...
    <div class="max-w-md mx-auto bg-white p-8 rounded shadow-md mt-5">
        <h1 class="font-serif font-bold text-center ">Application For the semester examination </h1><br>
            ...
            <form action="Exams.php" method="post">
                ...
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"  type="text" name="fname" required>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"  type="text" name="contact_no" required>
                    </div>

                    <div class="mb-4">
                        <label class="block text-gray-700 text-sm font-bold mb-2" for="mail"> Email Id: </label>
                        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"  type="email" name="mail" required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"  type="text" name="nic" required>
                        </div>

                    

                    <div class="mb-4">
                        <label class="block text-gray-700 text-sm font-bold mb-2" for="name"> Registation Number: </label>
                        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"  type="text" name="student_id" required>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-3 py-2 rounded shadow leading-tight focus:outline-none focus:shadow-outline" name="dep" required>
                                <option value="">Select</option>
                                <optgroup label="HNDIT">
                                <option value="HNDIT">HNDIT 1st Year</option>
                                <option value="HNDIT">HNDIT 2nd Year</option>
                                </optgroup>
                                <optgroup label="HNDE">
                                <option value="HNDE">HNDE 1st Year</option>
                                <option value="HNDE">HNDE 2nd Year</option>
                                </optgroup>
                                <optgroup label="HNDA">
                                <option value="HNDA">HNDA 1st Year</option>
                                <option value="HNDA">HNDA 2nd Year</option>
                                <option value="HNDA">HNDA 3nd Year</option>
                                <option value="HNDA">HNDA 4nd Year</option>
                                </optgroup>
                            </select>
                        </div>

                        <div class="mb-4">
                            <label class="block text-gray-700 text-sm font-bold mb-2" for="dep"> semester: </label>
                            <select class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-3 py-2 rounded shadow leading-tight focus:outline-none focus:shadow-outline" name="sem" required>
                                <option value="">Select</option>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Enter Your Message here."   name="Sname" required>
